...
const appsNavigationConfig = [
    {
        ...
        subMenu: [
            ...
            {
                key: 'apps.recruitmentPortal',
                path: '',
                title: 'Recruitment Portal',
                translateKey: 'nav.recruitmentPortal.recruitmentPortal',
                icon:'project',
                type: NAV_ITEM_TYPE_COLLAPSE,
                authority: [ADMIN, USER],
                subMenu: [
                    {
                        key: 'appsrecruitmentPortal.jobListing',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Job/jobListing`,
                        title: 'Job Listing',
                        translateKey: 'nav.appsrecruitmentPortal.jobListing',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.createJob',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Job/createJob`,
                        title: 'Create Job',
                        translateKey: 'nav.appsrecruitmentPortal.createJob',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.jobApplication',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Job/jobApplication`,
                        title: 'Job Application',
                        translateKey: 'nav.appsrecruitmentPortal.jobApplication',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.jobDetails',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Job/jobDetails`,
                        title: 'Job Details',
                        translateKey: 'nav.appsrecruitmentPortal.jobDetails',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.candidateListing',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Candidates/candidateListing`,
                        title: 'Candidate Listing',
                        translateKey: 'nav.appsrecruitmentPortal.candidateListing',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.cnandidateDetails',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Candidates/candidateDetails`,
                        title: 'Candidate Details',
                        translateKey: 'nav.appsrecruitmentPortal.candidateDetails',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.createDepartment',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Departments/createDepartment`,
                        title: 'Create Deartment',
                        translateKey: 'nav.appsrecruitmentPortal.createDepartment',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.departmentListing',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Departments/departmentListing`,
                        title: 'Department Listing',
                        translateKey: 'nav.appsrecruitmentPortal.departmentListing',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
                    ...
                    {
                        key: 'appsrecruitmentPortal.departmentDetails',
                        path: `${APP_PREFIX_PATH}/RecruitmentPortal/Departments/departmentDetails`,
                        title: 'Department Details',
                        translateKey: 'nav.appsrecruitmentPortal.departmentDetails',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        subMenu: [],
