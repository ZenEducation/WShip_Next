  ...
  const home = {
    ...
    pages: [
      ...
      },
      {
        ...
        name: "Crypto App",
        condition: true,
        path: "/PC/home/home_10",
      },
      {
        id: uuidv4(),
        name: "Crypto Trading",
        condition: true,
        path: "/PC/home/home_11",
      },
      {
        id: uuidv4(),
        name: "ICO Landing",
        condition: true,
        path: "/PC/home/home_12",
      },
    ],
  };
  ...
  const page = {
    ...
    pages: [
      ...
      },
      {
        ...
        name: "Case Studies",
        condition: true,
        path: "/PC/case-studies",
      },
      {
        id: uuidv4(),
        name: "Single Case Study",
        condition: true,
        path: "/PC/case-studies/case_study_1",
      },
      {
        id: uuidv4(),
        name: "Careers",
      ...
      },
      {
        id: uuidv4(),
        name: "Item Details",
        path: "/PC/item/item_20",
      },
      {
        id: uuidv4(),
        name: "Explore Collections",
        path: "/PC/collection/explore_collection",
      },
      {
        id: uuidv4(),
        name: "Collection",
        path: "/PC/collection/avatar_1",
      },
      {
        id: uuidv4(),
        name: "Activity",
      ...
      },
      {
        id: uuidv4(),
        name: "User",
        path: "/PC/user/avatar_6",
      },
      {
        id: uuidv4(),
        name: "Edit Profile",
        path: "/PC/profile/user_avatar",
      },
      {
        id: uuidv4(),
        name: "About",
          ...
          <div className="js-mobile-menu dark:bg-jacarta-800 invisible fixed inset-0 z-10 ml-auto items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
            <nav className="navbar w-full">
              <ul className="flex flex-col lg:flex-row">
                ...
                {/* create */}
                <li className="group">
                  <Link legacyBehavior href="/PC/create">
                    <a>
                      <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                        <span
                          className={
                            isChildrenPageActive(route.asPath, "/PC/create")
                              ? "text-accent dark:text-accent"
                              : ""
                          }
                        >
            ...
            <div className="ml-8 hidden items-center lg:flex xl:ml-12">
              ...
              <div className="js-nav-dropdown group-dropdown relative">
                ...
                <div className="dropdown-menu dark:bg-jacarta-800 group-dropdown-hover:opacity-100 group-dropdown-hover:visible !-right-4 !top-[85%] !left-auto z-10 min-w-[14rem] whitespace-nowrap rounded-xl bg-white transition-all will-change-transform before:absolute before:-top-3 before:h-3 before:w-full lg:absolute lg:grid lg:!translate-y-4 lg:py-4 lg:px-2 lg:shadow-2xl hidden lg:invisible lg:opacity-0">
                  ...
                  <Link legacyBehavior href="/PC/user/avatar_6">
                  ...
                  <Link legacyBehavior href="/PC/profile/user_avatar">
                    <a className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                  ...
                  <Link legacyBehavior href="/PC/login">
                    <a className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
              ...
              <Link legacyBehavior href="/PC/create">
                <a>
                  <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                    <span
                      className={
                        isChildrenPageActive("/PC/create", route.asPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
