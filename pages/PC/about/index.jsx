...
import Team from "../../../components/PublicUI/about/Team";
import Partners from "../../../components/PublicUI/partners/Partners";
import About_news from "../../../components/PublicUI/blog/about_news";
  ...
  return (
    <>
      ...
      <section className="pb-24">
        <div className="container">
          {/* <!-- Video Lightbox --> */}
          <figure className="before:bg-jacarta-900/25 rounded-xl relative mt-16 overflow-hidden before:absolute before:inset-0 lg:-mt-96">
            <img
