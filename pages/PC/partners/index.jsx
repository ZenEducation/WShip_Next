...
import HeadLine from "../../../components/PublicUI/headLine";
import { works_data } from "../../../data/partners_data";
import Feature_collections_carousel from "../../../components/PublicUI/carousel/Feature_collection_carousel";
import Accordion from "../../../components/PublicUI/accordion";
import { accordion_data } from "../../../data/help_center_data";
import Link from "next/link";
import PartnersComp from "../../../components/PublicUI/partners/Partners";
        ...
        <section className="bg-accent py-28">
          <div className="container">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <Link legacyBehavior href="/PC/contact">
