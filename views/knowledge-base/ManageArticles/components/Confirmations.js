...
const Confirmations = ({ data }) => {
    ...
    const articleDeleteConfirmation = useSelector(
        (state) =>
            state.knowledgeBaseManageArticles.state.articleDeleteConfirmation
    )
    const categoryDeleteConfirmation = useSelector(
        (state) =>
            state.knowledgeBaseManageArticles.state.categoryDeleteConfirmation
    )
    const categoryRenameDialog = useSelector(
        (state) => state.knowledgeBaseManageArticles.state.categoryRenameDialog
    )
    const categoryAddDialog = useSelector(
