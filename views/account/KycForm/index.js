...
const PersonalInformation = dynamic(
  async () => await import("./components/PersonalInformation")
);
const Identification = dynamic(
  async () => await import("./components/Identification")
);
const AddressInfomation = dynamic(
  async () => await import("./components/AddressInfomation")
);
const FinancialInformation = dynamic(
  async () => await import("./components/FinancialInformation")
);
const AccountReview = dynamic(
  async () => await import("./components/AccountReview")
);
