    ...
    return (
        <>
            ...
            <ol>
                <li>
                    <p>
                        First, create a <code>xxxService.js</code> file(depends
                        on your feature or module) under <code>services</code>{' '}
                        directory
                    </p>
                </li>
                <li>
                    <p>
                        ...
                        <code>ApiService.fetchData</code> method and pass in
                        your api configuration details as the code below:
                    </p>
...
const YourComponent = props => {
	...
	return (
		...
                ...
                <li>
                    <p>
                        you can also use this service with{' '}
...
export default yourSlice.reducer`}</SyntaxHighlighter>
            ...
            <div className="mt-10" id="proxying">
                <h5>Proxying</h5>
                <p className="mt-1">
                    Developer often consume API from different servers than the
                    frontend application, there are complications that arise as
                    a result of requests being sent across both servers, here is
                    some way to setting up a proxy server.
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <p className="mt-1">
                            You can choose to setup with{' '}
                            <code>http-proxy-middleware</code> for more flexible
                            configuration.
                        </p>
                        <p>
                            Create <code>setupProxy.js</code> and place under{' '}
                            <code>src/</code> directory with code following
                            code:
                        </p>
