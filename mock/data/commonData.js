...
export const searchQueryPoolData = [
    ...
    {
        title: 'Job Listing',
        url: '/app/RecruitmentPortal/Job/jobListing',
        icon: 'joblisting',
    ...
    {
        title: 'Create Job',
        url: '/app/RecruitmentPortal/Job/createJob',
        icon: 'createJob',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },
    {
        ...
        url: '/app/RecruitmentPortal/Job/JobApplication',
        icon: 'jobApplication',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },    {
        title: 'Job Details',
        url: '/app/RecruitmentPortal/Job/JobDetails',
        icon: 'jobDetails',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },    {
        title: 'Candidate Listing',
        url: '/app/RecruitmentPortal/Candidates/candidateListing',
        icon: 'candidateListing',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },    {
        title: 'Candidate Details',
        url: '/app/RecruitmentPortal/Candidates/candidateDetails',
        icon: 'joblisting',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    }, 
       {
        ...
        url: '/app/RecruitmentPortal/Departments/createDeparment',
        icon: 'createDeparment',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },    {
        title: 'Department Listing',
        url: '/app/RecruitmentPortal/Departments/departmentListing',
        icon: 'departmentListing',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },    {
        title: 'Department Details',
        url: '/app/RecruitmentPortal/Departments/departmentDetails',
        icon: 'departmentDetails',
        category: 'Recruitment Portal',
        categoryTitle: 'Apps',
    },
    {
